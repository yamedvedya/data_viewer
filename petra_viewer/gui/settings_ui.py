...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.chk_p23scan.setChecked(True)
        self.chk_p23scan.setObjectName("chk_p23scan")
        self.gridLayout_12.addWidget(self.chk_p23scan, 3, 0, 1, 1)
        ...
        self.chk_p11scan.setChecked(True)
