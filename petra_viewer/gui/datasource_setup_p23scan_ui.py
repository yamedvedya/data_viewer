...
class Ui_P23ScanSetup(object):
    def setupUi(self, P23ScanSetup):
        ...
        P23ScanSetup.resize(640, 726)
        self.horizontalLayout = QtWidgets.QHBoxLayout(P23ScanSetup)
        ...
        self.line_3 = QtWidgets.QFrame(P23ScanSetup)
        self.line_3.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_3.setObjectName("line_3")
        self.verticalLayout.addWidget(self.line_3)
        self.label = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rb_mask_off = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.rb_mask_off.setFont(font)
        self.rb_mask_off.setChecked(True)
        self.rb_mask_off.setObjectName("rb_mask_off")
        self.bg_mask_option = QtWidgets.QButtonGroup(P23ScanSetup)
        ...
        self.rb_mask_on = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lb_mask_file = QtWidgets.QLabel(P23ScanSetup)
        ...
        self.but_load_mask = QtWidgets.QPushButton(P23ScanSetup)
        ...
        self.line_5 = QtWidgets.QFrame(P23ScanSetup)
        self.line_5.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.verticalLayout.addWidget(self.line_5)
        self.label_9 = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rb_fill_off = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.rb_fill_off.setFont(font)
        self.rb_fill_off.setChecked(True)
        self.rb_fill_off.setObjectName("rb_fill_off")
        self.bg_fill_option = QtWidgets.QButtonGroup(P23ScanSetup)
        ...
        self.rb_fill_on = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_10 = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.horizontalLayout_9.addWidget(self.label_10)
        self.sb_fill = QtWidgets.QSpinBox(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.sb_fill.setFont(font)
        self.sb_fill.setObjectName("sb_fill")
        self.horizontalLayout_9.addWidget(self.sb_fill)
        self.label_11 = QtWidgets.QLabel(P23ScanSetup)
        self.label_11.setObjectName("label_11")
        self.horizontalLayout_9.addWidget(self.label_11)
        self.verticalLayout.addLayout(self.horizontalLayout_9)
        self.line = QtWidgets.QFrame(P23ScanSetup)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.verticalLayout.addWidget(self.line)
        self.label_6 = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.rb_ff_off = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.rb_ff_off.setFont(font)
        self.rb_ff_off.setChecked(True)
        self.rb_ff_off.setObjectName("rb_ff_off")
        self.bg_ff_option = QtWidgets.QButtonGroup(P23ScanSetup)
        ...
        self.rb_ff_on = QtWidgets.QRadioButton(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_7 = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.horizontalLayout_8.addWidget(self.label_7)
        self.dsb_ff_from = QtWidgets.QDoubleSpinBox(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.label_8 = QtWidgets.QLabel(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.horizontalLayout_8.addWidget(self.label_8)
        self.dsb_ff_to = QtWidgets.QDoubleSpinBox(P23ScanSetup)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.lb_ff_file = QtWidgets.QLabel(P23ScanSetup)
        ...
        self.but_load_ff = QtWidgets.QPushButton(P23ScanSetup)
        ...
        self.line_4 = QtWidgets.QFrame(P23ScanSetup)
        ...
        self.gv_main = GraphicsView(P23ScanSetup)
    ...
    def retranslateUi(self, P23ScanSetup):
        ...
        self.label.setText(_translate("P23ScanSetup", "Mask corection:"))
        self.rb_mask_off.setText(_translate("P23ScanSetup", "OFF"))
        self.rb_mask_on.setText(_translate("P23ScanSetup", "ON"))
        self.but_load_mask.setText(_translate("P23ScanSetup", "Load new"))
        self.label_9.setText(_translate("P23ScanSetup", "Mask gaps fill:"))
        self.rb_fill_off.setText(_translate("P23ScanSetup", "OFF"))
        self.rb_fill_on.setText(_translate("P23ScanSetup", "ON"))
        self.label_10.setText(_translate("P23ScanSetup", "radius:"))
        self.label_11.setText(_translate("P23ScanSetup", "px."))
        self.label_6.setText(_translate("P23ScanSetup", "Flat field correction:"))
        self.rb_ff_off.setText(_translate("P23ScanSetup", "OFF"))
        self.rb_ff_on.setText(_translate("P23ScanSetup", "ON"))
        self.label_7.setText(_translate("P23ScanSetup", "from"))
        self.label_8.setText(_translate("P23ScanSetup", "to"))
        self.but_load_ff.setText(_translate("P23ScanSetup", "Load new"))
